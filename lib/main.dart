...
import 'screens/add_short_screen.dart';
import 'screens/trending_all_screen.dart';
import 'screens/featured_all_screen.dart';
import 'screens/live_all_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/add-short': (context) => const AddShortScreen(),
        '/trending-all': (context) => const TrendingAllScreen(),
        '/featured-all': (context) => const FeaturedAllScreen(),
        '/live-all': (context) => const LiveAllScreen(),
      },
