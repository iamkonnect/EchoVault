...
const String baseUrl = 'http://localhost:5000'; // For local testing
// const String baseUrl = 'https://api.echovault.com'; // For production
...
final apiServiceProvider = Provider<EchoVaultApiService>((ref) {
  ...
  return EchoVaultApiService(dio: dio, baseUrl: baseUrl);
});

// Artist Service Provider
final artistServiceProvider = Provider<ArtistService>((ref) {
  final dio = ref.watch(dioProvider);
  return ArtistService(dio: dio, baseUrl: baseUrl);
});
