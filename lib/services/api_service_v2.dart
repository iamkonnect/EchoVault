...
class EchoVaultApiService {
  ...
  Future<List<Map<String, dynamic>>> getConversations() async {
    try {
      final res = await apiClient.get('/api/messages/conversations');
      return List<Map<String, dynamic>>.from(res['data'] ?? []);
    } catch (e) {
      return [];
    }
  ...
  Future<List<Map<String, dynamic>>> getAllTracks() async {
    try {
      final response = await apiClient.get('/api/tracks');
      return List<Map<String, dynamic>>.from(response['data'] ?? response as List);
    } catch (e) {
      return [];
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getShorts() async {
    try {
      final response = await apiClient.get('/api/shorts');
      return List<Map<String, dynamic>>.from(response['data'] ?? response as List);
    } catch (e) {
      return [];
    }
