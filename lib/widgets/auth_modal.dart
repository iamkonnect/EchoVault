                    ...
                    children: [
                      ...
                      _buildTextField(
                        ...
                        validator: (value) {
                          ...
                          if (!isLogin && !RegExp(r'^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$').hasMatch(value)) {
  ...
  Widget _buildHeader() {
    return Column(
      children: [
        ...
        Text(
          isLogin ? 'Sign in to continue your journey' : 'Join EchoVault and sync your music',
        ...
        onPressed: _isLoading ? null : () async {
          if (_formKey.currentState!.validate()) {
            ...
            if (isLogin) {
              ...
              success = await notifier.signUp(name, username, email, password);
            }
            ...
            if (mounted) {
              ...
              if (success) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(isLogin ? 'Signed in successfully!' : 'Account created! Welcome to EchoVault!'),
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Invalid credentials or weak password. Try akwera@gmail.com / 1234Abc!')),
                );
              }
            }
          }
